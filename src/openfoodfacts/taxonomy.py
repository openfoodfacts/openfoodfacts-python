...
#: Taxonomies common to every flavor, i.e. the intersection of the
#: ``@taxonomized_fields`` lists defined in ProductOpener for off, obf, opff
#: and opf. Each flavor below is built from this base set plus its own
#: flavor-specific taxonomies.
_shared_taxonomies = (
    TaxonomyType.unit,
    ...
    TaxonomyType.packaging,
    TaxonomyType.label,
    TaxonomyType.category,
    TaxonomyType.nutrient,
    TaxonomyType.misc,
    TaxonomyType.periods_after_opening,
    TaxonomyType.data_quality,
    TaxonomyType.improvement,
    TaxonomyType.brand,
    TaxonomyType.origins_adjective,
    TaxonomyType.storage_condition,
)
...
TAXONOMY_MAPPING = {
    Flavor.off: (
        *_shared_taxonomies,
        ...
        TaxonomyType.additives_class,
        TaxonomyType.ingredient,
        TaxonomyType.food_group,
        TaxonomyType.ingredients_processing,
        ...
        TaxonomyType.ingredients_analysis,
        TaxonomyType.nutrient_level,
...
def create_brand_taxonomy_mapping(taxonomy: Taxonomy) -> Dict[str, str]:
    ...
    for node in taxonomy.iter_nodes():
        ...
        mapping[unprefixed_key] = node.names.get(
            "xx", node.names.get("en", node.names.get(prefix, unprefixed_key))
        )
    return mapping
